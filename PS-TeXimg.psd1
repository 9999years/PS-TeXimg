...
GUID = 'fcd51c6a-b3ca-4a91-bfce-7373f032754a'

# Author of this module
Author = 'Rebecca Turner'

# Company or vendor of this module
CompanyName = 'becca.ooo'

# Copyright statement for this module
Copyright = '(c) 2017 Rebecca Turner / MIT license'
...
ScriptsToProcess = @("PS-TeXimg.ps1")
...
# cmdlets to export.
CmdletsToExport = @("New-TeXimg", "Convert-PDFtoPNG")
...
PrivateData = @{
	...
	PSData = @{
		...
		# in online galleries.
		Tags = @("LaTeX", "PDF", "PNG", "image")

		# A URL to the license for this module.
		LicenseUri = 'https://www.debian.org/legal/licenses/mit'

		# A URL to the main website for this project.
		ProjectUri = 'https://github.com/9999years/PS-TeXimg'
